...
import "./Spotify.scss"
const Spotify = ({windowName,display,setDisplay, bringToFront}) => {
  return (
    <MacWindow windowName={windowName} display={display} setDisplay={setDisplay} bringToFront={bringToFront} w={window.innerWidth<600 ? window.innerWidth*0.9 : 600} h="400">
